...
function displayProducts(data) {
  ...
  data.forEach((elements) => {
    ...
    newProduct += `
        <div class="flex justify-center w-[32%] max-h-[inherit] min-h-[450px] relative items-center shadow-custom rounded-md transition-all duration-300 ease-in-out hover:cursor-pointer hover:shadow-lg">
